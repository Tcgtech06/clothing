  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-rose-100/50 to-rose-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-rose-50/60 backdrop-blur-sm rounded-lg shadow-md p-6 mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-rose-50/60 backdrop-blur-sm rounded-lg shadow-md p-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          <Link href="/orders">
            <div className="bg-rose-50/60 backdrop-blur-sm rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer group">
