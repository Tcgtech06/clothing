...
export default function CartPage() {
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-rose-50 via-rose-100/50 to-rose-50 flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto px-3 md:px-4 py-4 md:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-3 md:space-y-4">
            {cart.map((item) => (
              <div key={`${item.product.id}-${item.selectedColor}-${item.selectedSize}`} className="bg-rose-50/60 backdrop-blur-sm rounded-lg shadow-md p-3 md:p-4">
          ...
          <div className="lg:col-span-1">
            <div className="bg-rose-50/60 backdrop-blur-sm rounded-lg shadow-md p-4 md:p-6 lg:sticky lg:top-20">
